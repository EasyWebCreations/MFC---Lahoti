    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark ">
        ...
        <div style="display:flex">
          ...
          <div id="box1" style="background-color: #f3efe7;padding-top:3%;border:5px solid black;margin-top:4%">
            <div  class="input-group mb-3  w-75">
                ...
                <input id="premium" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
              </div>
              <div  class="input-group mb-3 w-75">
                <span class="input-group-text" id="inputGroup-sizing-default">PPT</span>
                <input id="ppt" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
              </div>
              <!-- <div  class="input-group mb-3 w-75">
              ...
              <div  class="input-group mb-3 w-75">
                ...
                <span id="xirr" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"></span>
              </div>
              <!-- <div  class="input-group mb-3 w-75">
              ...
              <div class="d-grid gap-2 col-6 mx-auto">
                ...
                <button  class="btn btn-primary" type="button" data-toggle="modal" data-target="#exampleModalCenter" onclick="function1()">Calculate</button>
              </div>
      ...
      <!-- <div class="output">
        ...
        <div id="box2" style="background-color: #f3efe7;padding-top:3%;border:5px solid black">
          <div  class="input-group mb-3  w-75">
              <span class="input-group-text" id="inputGroup-sizing-default">Premium</span>
              <input id="premium_b" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
            </div>
            <div  class="input-group mb-3 w-75">
              <span class="input-group-text" id="inputGroup-sizing-default">PPT</span>
              <input id="ppt_b" type="text" class="form-control" aria-label="Sizing example input"  aria-describedby="inputGroup-sizing-default">
            </div>
            <div  class="input-group mb-3 w-75">
              <span class="input-group-text" id="inputGroup-sizing-default">Returns after maturity</span>
              <input id="returns_after_maturity_b" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
            </div>
            <div  class="input-group mb-3 w-75">
              <span class="input-group-text" id="inputGroup-sizing-default">Surrender Year No</span>
              <input id="surrender_year_b" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
            </div>
            <!-- <div  class="input-group mb-3 w-75">
              <span class="input-group-text" id="inputGroup-sizing-default">Rate Of Intrest</span>
            ...
            <div  class="input-group mb-3 w-75">
              <span class="input-group-text" id="inputGroup-sizing-default">Returns if surrendered</span>
              <input  type="text" id="returns_if_surrendered_b" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
            </div>
      ...
      <section id="MF">
       ...
       <div id="box3" style="background-color: #f3efe7;padding-top:3%;border:5px solid black">
        <div  class="input-group mb-3  w-75">
            ...
            <input id="returns_if_surrendered01" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
          </div>
          <div  class="input-group mb-3 w-75">
          ...
          <div  class="input-group mb-3 w-75">
            ...
            <input id="rate_of_interest" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
          </div>
          <div class="d-grid gap-2 col-6 mx-auto">
            <!-- <button class="btn btn-primary" type="button">Button</button> -->
            <button class="btn btn-primary" type="button" onclick="function2()" style="margin-bottom:5%">Calculate </button>
          </div>
        </div>
        <div class="output">
          <div id="output1">
      ...
      <section id="sip">
        ...
        <div id="box4" style="padding-bottom:3%;background-color: #f3efe7;padding-top:3%;border:5px solid black">
          <div  class="input-group mb-3  w-75">
              ...
              <input id="sip_a" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
            </div>
            <div  class="input-group mb-3 w-75">
              <span class="input-group-text" id="inputGroup-sizing-default">Investment Period</span>
              <input id="invp_a" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
            </div>
...
<!-- particles.js container --> <!-- particles.js lib - https://github.com/VincentGarreau/particles.js --> <script src="http://cdn.jsdelivr.net/particles.js/2.0.0/particles.min.js"></script> <!-- stats.js lib --> <script src="http://threejs.org/examples/js/libs/stats.min.js"></script>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footerr" style="margin-bottom:20px">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" style="margin-left: 25%;margin-right:10%">Happy</button>
